...
const ProgLangFormRanking = ({ record }: PropsType): ReactElement => {
    return (
        <>
            <Row>
                <Col>
                    <Form.Label className='fw-bolder'>Ranking</Form.Label>
                    ...
                    <Accordion>
                        <Accordion.Item eventKey="0" >
                            <Accordion.Header>
                                ...
                                ATTENTION! To fine tune the ranges it is recommended to complete an extraction first and calculate the range values from the developer's scores.
                            </Accordion.Header>
                            <Accordion.Body>
                                To do that 
                                <ol>
                                    ...
                                    <li>by clicking the <i>Calculate</i> button the application will transform the values back to programming language level</li>
                                </ol>
